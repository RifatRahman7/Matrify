...
const PartnersMediaSection = () => (
    <div className="relative w-full max-w-5xl mx-auto py-10 flex flex-col items-center my-8 roboto">
        ...
        ></div>
        {/* Glassmorphism card */}
        <div className="w-full bg-white/40 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/30 px-4 py-12 flex flex-col items-center">
                ...
                <div className="flex items-center gap-8 animate-scroll-logos">
                    {[...partners, ...partners].map((partner, idx) => (
                        <a
                            ...
                            style={{ flex: "0 0 auto" }}
                        >
                            <div className="bg-white/70 rounded-xl shadow-lg p-3 flex items-center justify-center w-24 h-24 group-hover:scale-105 transition-transform duration-200">
                                <img
                                    src={partner.logo}
                                    alt={partner.name}
