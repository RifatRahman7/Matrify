...
const SuccessCounter = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-12 roboto">
      <div className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-8 p-4">
        Matrify Success in Numbers
      </div>
