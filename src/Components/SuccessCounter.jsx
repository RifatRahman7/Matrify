...
const CounterCard = ({ icon, label, value, color }) => (
  <div
    className="flex flex-col items-center justify-center
      bg-white/60 dark:bg-slate-900/80 backdrop-blur-lg
      rounded-2xl shadow-2xl border border-white/30 dark:border-slate-700
      p-8 min-w-[180px] hover:scale-105 transition-transform duration-200 cursor-pointer"
  >
    <div className={`text-4xl mb-2 ${color}`}>{icon}</div>
    <div className="text-3xl font-extrabold text-gray-800 dark:text-gray-100 mb-1">
