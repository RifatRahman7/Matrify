...
const ReviewSection = () => (
    <div className="relative w-full max-w-5xl mx-auto py-12 roboto">
        ...
        <div className="flex justify-center mb-8">
            <div className="bg-white/30 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 px-6 py-6 inline-block">
            ...
            {reviews.map((review, idx) => (
                ...
                >
                    <img
                        src={review.image}
                        alt={review.name}
                        className="w-20 h-20 rounded-full object-cover border-4 border-green-200 shadow mb-4"
                    />
                    <div className="text-lg font-bold text-gray-800 mb-1">{review.name}</div>
