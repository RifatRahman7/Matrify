...
const PromoSection = () => {
  ...
  return (
    <div className="relative p-5 w-full max-w-5xl mx-auto py-10 flex items-center justify-center my-8">
      {/* Blurred background */}
      <div
      ...
      <div className="w-full max-w-5xl bg-white/40 dark:bg-slate-950/70 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/30 dark:border-slate-700 px-8 py-12 flex flex-col items-center transition-colors duration-500">
        ...
        <h2 className="text-2xl md:text-2xl font-bold text-center text-gray-800 dark:text-gray-100 mb-4 tracking-tight">
          Find Your Perfect Match on Matrify!
        </h2>
        
        <p className="text-gray-700 dark:text-gray-300 text-center text-md md:text-md mb-8">
        ...
        <button
          ...
          className="flex cursor-pointer items-center gap-2 bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-semibold px-4 py-3 rounded-full shadow-lg text-lg transition-transform duration-300 hover:scale-105"
        >
          <FaUserPlus className="text-lg" />
          <span className="text-sm">See Biodatas</span>
        </button>
      </div>
    </div>
  );
